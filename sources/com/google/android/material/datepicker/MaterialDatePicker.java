...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C6372R.C6374drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C6372R.C6374drawable.material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    private void enableEdgeToEdgeIfNeeded(Window window) {
        if (!this.edgeToEdgeEnabled) {
            final View findViewById = requireView().findViewById(C6372R.C6375id.fullscreen_header);
    ...
    private static int getPaddedPickerWidth(@NonNull Context context) {
        ...
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C6372R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C6372R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C6372R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    static boolean isNestedScrollable(@NonNull Context context) {
        return readMaterialCalendarStyleBoolean(context, C6372R.attr.nestedScrollable);
    }
    ...
    static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C6372R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C6372R.C6375id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C6372R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void updateToggleContentDescription(@NonNull CheckableImageButton checkableImageButton) {
        String str;
        if (this.headerToggleButton.isChecked()) {
            str = checkableImageButton.getContext().getString(C6372R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            str = checkableImageButton.getContext().getString(C6372R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C6372R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, C6372R.attr.materialCalendarStyle, C6372R.C6378style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        int i;
        if (this.fullscreen) {
            i = C6372R.C6377layout.mtrl_picker_fullscreen;
        } else {
            i = C6372R.C6377layout.mtrl_picker_dialog;
        }
        View inflate = layoutInflater.inflate(i, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C6372R.C6375id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            inflate.findViewById(C6372R.C6375id.mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) inflate.findViewById(C6372R.C6375id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C6372R.C6375id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C6372R.C6375id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C6372R.C6375id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C6372R.C6375id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C6372R.dimen.mtrl_calendar_dialog_background_inset);
