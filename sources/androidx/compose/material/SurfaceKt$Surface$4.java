...
final class SurfaceKt$Surface$4 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    SurfaceKt$Surface$4(Modifier modifier, Shape shape, long j, float f, int i, BorderStroke borderStroke, float f2, MutableInteractionSource mutableInteractionSource, boolean z, C13074a<C11921v> aVar, C13088o<? super Composer, ? super Integer, C11921v> oVar) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2031491085, i2, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:226)");
            }
            ...
            Shape shape2 = shape;
            Modifier r1 = ClickableKt.m32979clickableO2vRcR0$default(SurfaceKt.m34133surface8ww4TTg(modifier, shape2, SurfaceKt.m34134surfaceColorAtElevationcq6XJ1M(this.$color, (ElevationOverlay) composer2.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 12) & 14), this.$border, this.$elevation), this.$interactionSource, RippleKt.m34235rememberRipple9IZ8Weo(false, 0.0f, 0, composer, 0, 7), this.$enabled, (String) null, (Role) null, this.$onClick, 24, (Object) null);
            ...
            oVar.invoke(composer2, Integer.valueOf((i3 >> 27) & 14));
