...
final class MenuKt$DropdownMenuContent$1$1 extends C12777p implements Function1<GraphicsLayerScope, C11921v> {
    ...
    public final void invoke(GraphicsLayerScope graphicsLayerScope) {
        ...
        graphicsLayerScope.setScaleX(MenuKt.m34487DropdownMenuContent$lambda1(this.$scale$delegate));
        graphicsLayerScope.setScaleY(MenuKt.m34487DropdownMenuContent$lambda1(this.$scale$delegate));
        graphicsLayerScope.setAlpha(MenuKt.m34488DropdownMenuContent$lambda3(this.$alpha$delegate));
