...
final class CheckboxKt$Checkbox$3 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    CheckboxKt$Checkbox$3(boolean z, Function1<? super Boolean, C11921v> function1, Modifier modifier, boolean z2, MutableInteractionSource mutableInteractionSource, CheckboxColors checkboxColors, int i, int i2) {
        super(2);
        this.$checked = z;
