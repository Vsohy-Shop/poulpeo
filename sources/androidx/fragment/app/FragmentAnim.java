            ...
            if (i != 8194) {
                if (i != 8197) {
                    if (i != 4099) {
                        ...
                        return C1989R.animator.fragment_fade_enter;
                    } else {
                        return C1989R.animator.fragment_fade_exit;
                    }
                } else if (z) {
                ...
                return C1989R.animator.fragment_close_enter;
            } else {
                return C1989R.animator.fragment_close_exit;
            }
        } else if (z) {
            return C1989R.animator.fragment_open_enter;
        } else {
            return C1989R.animator.fragment_open_exit;
        }
    }
