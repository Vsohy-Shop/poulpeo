...
@C12739f(mo50609c = "androidx.compose.material3.ChipElevation$animateElevation$1$1", mo50610f = "Chip.kt", mo50611l = {1505}, mo50612m = "invokeSuspend")
/* compiled from: Chip.kt */
final class ChipElevation$animateElevation$1$1 extends C12746l implements C13088o<C13995l0, C12074d<? super C11921v>, Object> {
    final /* synthetic */ InteractionSource $interactionSource;
    final /* synthetic */ SnapshotStateList<Interaction> $interactions;
    int label;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChipElevation$animateElevation$1$1(InteractionSource interactionSource, SnapshotStateList<Interaction> snapshotStateList, C12074d<? super ChipElevation$animateElevation$1$1> dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C08451 r1 = new C10967g<Interaction>() {
    ...
    public final Object invoke(C13995l0 l0Var, C12074d<? super C11921v> dVar) {
        return ((ChipElevation$animateElevation$1$1) create(l0Var, dVar)).invokeSuspend(C11921v.f18618a);
    }
}
