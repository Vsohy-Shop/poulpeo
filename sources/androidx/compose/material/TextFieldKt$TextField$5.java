...
final class TextFieldKt$TextField$5 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    TextFieldKt$TextField$5(String str, Function1<? super String, C11921v> function1, Modifier modifier, boolean z, boolean z2, TextStyle textStyle, C13088o<? super Composer, ? super Integer, C11921v> oVar, C13088o<? super Composer, ? super Integer, C11921v> oVar2, C13088o<? super Composer, ? super Integer, C11921v> oVar3, C13088o<? super Composer, ? super Integer, C11921v> oVar4, boolean z3, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z4, int i, MutableInteractionSource mutableInteractionSource, Shape shape, TextFieldColors textFieldColors, int i2, int i3, int i4) {
        super(2);
        this.$value = str;
