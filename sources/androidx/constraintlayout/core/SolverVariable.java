...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    static /* synthetic */ class C12501 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.SolverVariable.C12501.<clinit>():void");
        }
    }
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i = C12501.$SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
    ...
    public void setSynonym(LinearSystem linearSystem, SolverVariable solverVariable, float f) {
        this.isSynonym = true;
        this.synonym = solverVariable.f391id;
        this.synonymDelta = f;
        int i = this.mClientEquationsCount;
        this.definitionId = -1;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public int compareTo(SolverVariable solverVariable) {
        return this.f391id - solverVariable.f391id;
    }
