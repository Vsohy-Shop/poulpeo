...
final class SwitchKt$Switch$4 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    SwitchKt$Switch$4(boolean z, Function1<? super Boolean, C11921v> function1, Modifier modifier, boolean z2, MutableInteractionSource mutableInteractionSource, SwitchColors switchColors, int i, int i2) {
        super(2);
        this.$checked = z;
