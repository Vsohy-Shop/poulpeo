...
public final class CaptionedImageCard extends Card {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public CaptionedImageCard(JSONObject jSONObject, CardKey.Provider provider, C3023b2 b2Var) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public CaptionedImageCard(JSONObject jSONObject, CardKey.Provider provider, C3023b2 b2Var, C8063a<?> aVar) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ CaptionedImageCard(JSONObject jSONObject, CardKey.Provider provider, C3023b2 b2Var, C8063a aVar, C3096d2 d2Var, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(jSONObject, provider, (i & 4) != 0 ? null : b2Var, (i & 8) != 0 ? null : aVar, (i & 16) != 0 ? null : d2Var);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CaptionedImageCard(JSONObject jSONObject, CardKey.Provider provider, C3023b2 b2Var, C8063a<?> aVar, C3096d2 d2Var) {
        ...
        C12775o.m28638h(string, "jsonObject.getString(car…y.CAPTIONED_IMAGE_IMAGE))");
        this.imageUrl = string;
        String string2 = jSONObject.getString(provider.getKey(CardKey.CAPTIONED_IMAGE_TITLE));
        C12775o.m28638h(string2, "jsonObject.getString(car…y.CAPTIONED_IMAGE_TITLE))");
        this.title = string2;
        String string3 = jSONObject.getString(provider.getKey(CardKey.CAPTIONED_IMAGE_DESCRIPTION));
        C12775o.m28638h(string3, "jsonObject.getString(car…IONED_IMAGE_DESCRIPTION))");
        this.description = string3;
        this.url = C8278g.m16455i(jSONObject, provider.getKey(CardKey.CAPTIONED_IMAGE_URL));
        this.domain = C8278g.m16455i(jSONObject, provider.getKey(CardKey.CAPTIONED_IMAGE_DOMAIN));
