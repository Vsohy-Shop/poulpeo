...
final class BottomNavigationKt$BottomNavigationTransition$1 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    BottomNavigationKt$BottomNavigationTransition$1(C13089p<? super Float, ? super Composer, ? super Integer, C11921v> pVar, int i, State<Float> state) {
        super(2);
        this.$content = pVar;
        this.$$dirty = i;
