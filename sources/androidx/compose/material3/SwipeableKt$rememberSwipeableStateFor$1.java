...
@C12739f(mo50609c = "androidx.compose.material3.SwipeableKt$rememberSwipeableStateFor$1", mo50610f = "Swipeable.kt", mo50611l = {512}, mo50612m = "invokeSuspend")
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!C12775o.m28634d(this.$value, this.$swipeableState.getCurrentValue())) {
                ...
                T t = this.$value;
                this.label = 1;
                if (SwipeableState.animateTo$material3_release$default(swipeableState, t, (AnimationSpec) null, this, 2, (Object) null) == c) {
                    return c;
                }
            }
        } else if (i == 1) {
