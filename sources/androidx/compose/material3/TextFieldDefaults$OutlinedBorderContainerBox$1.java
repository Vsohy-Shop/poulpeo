...
final class TextFieldDefaults$OutlinedBorderContainerBox$1 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    public final void invoke(Composer composer, int i) {
        this.$tmp0_rcvr.m34653OutlinedBorderContainerBoxnbWgWpA(this.$enabled, this.$isError, this.$interactionSource, this.$colors, this.$shape, this.$focusedBorderThickness, this.$unfocusedBorderThickness, composer, this.$$changed | 1, this.$$default);
    }
}
