...
/* renamed from: com.google.android.gms.internal.gtm.z5 */
public final class C5639z5 extends C5521r5 {
    ...
    public final C5528rc<?> mo33099b(C5276b4 b4Var, C5528rc<?>... rcVarArr) {
        ...
        while (i < size && i < ((List) ycVar.mo33142a()).size()) {
            if (ycVar.mo33628m(i)) {
                rcVar = ((C5491p5) wcVar.mo33142a()).mo33133a(b4Var, (C5528rc) list.get(i), new C5589vc(Double.valueOf((double) i)), ycVar);
                C9713p.m20278m(!C5345fd.m7946j(rcVar));
            } else {
                rcVar = null;
            }
            arrayList.add(rcVar);
