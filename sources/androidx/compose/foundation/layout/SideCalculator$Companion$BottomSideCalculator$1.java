...
public final class SideCalculator$Companion$BottomSideCalculator$1 implements SideCalculator {
    ...
    public Insets adjustInsets(Insets insets, int i) {
        ...
        C12775o.m28638h(a, "of(oldInsets.left, oldIn…ldInsets.right, newValue)");
        return a;
    }

    /* renamed from: consumedOffsets-MK-Hz9U  reason: not valid java name */
    public long m33314consumedOffsetsMKHz9U(long j) {
        return OffsetKt.Offset(0.0f, Offset.m35423getYimpl(j));
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m33315consumedVelocityQWom1Mo(long j, float f) {
