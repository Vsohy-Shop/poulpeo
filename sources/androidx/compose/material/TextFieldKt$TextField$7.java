...
final class TextFieldKt$TextField$7 extends C12777p implements C13089p<C13088o<? super Composer, ? super Integer, ? extends C11921v>, Composer, Integer, C11921v> {
    ...
    public final void invoke(C13088o<? super Composer, ? super Integer, C11921v> oVar, Composer composer, int i) {
        ...
        if ((i2 & 91) != 18 || !composer.getSkipping()) {
            ...
            int i3 = this.$$dirty;
            int i4 = this.$$dirty1;
            textFieldDefaults.TextFieldDecorationBox(text, oVar, z, z2, visualTransformation, mutableInteractionSource, z3, oVar3, oVar4, oVar5, oVar6, textFieldColors, (PaddingValues) null, composer, ((i4 >> 3) & 7168) | ((i2 << 3) & 112) | ((i3 >> 3) & MediaRouterJellybean.DEVICE_OUT_BLUETOOTH) | ((i4 << 9) & 57344) | ((i4 >> 6) & 458752) | ((i4 << 18) & 3670016) | ((i3 << 3) & 29360128) | ((i3 << 3) & 234881024) | ((i3 << 3) & 1879048192), ((i3 >> 27) & 14) | 3072 | ((i4 >> 24) & 112), 4096);
            if (ComposerKt.isTraceInProgress()) {
