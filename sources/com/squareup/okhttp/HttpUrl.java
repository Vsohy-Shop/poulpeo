...
public final class HttpUrl {
    ...
    static /* synthetic */ class C116841 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.okhttp.HttpUrl.C116841.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        private static String inet6AddressToAscii(byte[] bArr) {
            ...
            while (i2 < bArr.length) {
                if (i2 == i) {
                    ...
                    cVar.mo52496L((long) (((bArr[i2] & 255) << 8) | (bArr[i2 + 1] & 255)));
                    i2 += 2;
                }
            }
        ...
        public HttpUrl build() {
            if (this.scheme == null) {
                ...
                return new HttpUrl(this, (C116841) null);
            } else {
        ...
        public ParseResult parse(HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    if (access$200 != skipTrailingAsciiWhitespace) {
                        c = str2.charAt(access$200);
                    } else {
                        c = 65535;
                    }
    ...
    /* synthetic */ HttpUrl(Builder builder, C116841 r2) {
        this(builder);
    }
    ...
    static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3) {
        ...
        while (i3 < i2) {
            ...
            if (codePointAt < 32 || codePointAt == 127 || ((codePointAt >= 128 && z3) || str2.indexOf(codePointAt) != -1 || ((codePointAt == 37 && !z) || (codePointAt == 43 && z2)))) {
                ...
                canonicalize(cVar, str, i3, i2, str2, z, z2, z3);
                return cVar.mo52482B0();
            }
    ...
    static HttpUrl getChecked(String str) {
        ...
        int i = C116841.$SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
    ...
    static void canonicalize(C13121c cVar, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3) {
        C13121c cVar2 = null;
        while (i < i2) {
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z2) {
                    ...
                    cVar2.mo52509V0(codePointAt);
                    while (!cVar2.mo52552t()) {
    ...
    static void percentDecode(C13121c cVar, String str, int i, int i2, boolean z) {
        int i3;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
