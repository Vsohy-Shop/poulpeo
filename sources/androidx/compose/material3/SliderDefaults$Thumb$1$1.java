...
@C12739f(mo50609c = "androidx.compose.material3.SliderDefaults$Thumb$1$1", mo50610f = "Slider.kt", mo50611l = {683}, mo50612m = "invokeSuspend")
/* compiled from: Slider.kt */
final class SliderDefaults$Thumb$1$1 extends C12746l implements C13088o<C13995l0, C12074d<? super C11921v>, Object> {
    final /* synthetic */ MutableInteractionSource $interactionSource;
    final /* synthetic */ SnapshotStateList<Interaction> $interactions;
    int label;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SliderDefaults$Thumb$1$1(MutableInteractionSource mutableInteractionSource, SnapshotStateList<Interaction> snapshotStateList, C12074d<? super SliderDefaults$Thumb$1$1> dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C08951 r1 = new C10967g<Interaction>() {
    ...
    public final Object invoke(C13995l0 l0Var, C12074d<? super C11921v> dVar) {
        return ((SliderDefaults$Thumb$1$1) create(l0Var, dVar)).invokeSuspend(C11921v.f18618a);
    }
}
