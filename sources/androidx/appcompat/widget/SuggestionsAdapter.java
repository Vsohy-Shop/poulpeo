...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0129R.C0132id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C0129R.attr.textColorSearchUrl, typedValue, true);
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        if (i > 0) {
            fragment.appendQueryParameter(APIParams.LIMIT, String.valueOf(i));
        }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0129R.C0132id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
