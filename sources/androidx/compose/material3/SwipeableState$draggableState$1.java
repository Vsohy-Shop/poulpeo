...
final class SwipeableState$draggableState$1 extends C12777p implements Function1<Float, C11921v> {
    ...
    public final void invoke(float f) {
        ...
        float l = C13537l.m30885l(floatValue, this.this$0.getMinBound$material3_release(), this.this$0.getMaxBound$material3_release());
        float f2 = floatValue - l;
        ResistanceConfig resistance$material3_release = this.this$0.getResistance$material3_release();
        this.this$0.offsetState.setValue(Float.valueOf(l + (resistance$material3_release != null ? resistance$material3_release.computeResistance(f2) : 0.0f)));
