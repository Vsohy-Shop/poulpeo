...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @Deprecated
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo654to = 1000) int i2, boolean z, int i3) {
        ...
        static FontInfo create(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo654to = 1000) int i2, boolean z, int i3) {
