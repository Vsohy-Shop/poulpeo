...
public final class PaddingKt$absolutePaddingqDBjuR0$$inlined$debugInspectorInfo$1 extends C12777p implements Function1<InspectorInfo, C11921v> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("left", C1232Dp.m38466boximpl(this.$left$inlined));
        inspectorInfo.getProperties().set("top", C1232Dp.m38466boximpl(this.$top$inlined));
        inspectorInfo.getProperties().set("right", C1232Dp.m38466boximpl(this.$right$inlined));
        inspectorInfo.getProperties().set("bottom", C1232Dp.m38466boximpl(this.$bottom$inlined));
    }
}
