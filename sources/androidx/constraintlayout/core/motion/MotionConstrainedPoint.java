...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f394x, this.f395y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 18) {
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f394x, motionConstrainedPoint.f394x);
        zArr[2] = zArr[2] | diff(this.f395y, motionConstrainedPoint.f395y);
