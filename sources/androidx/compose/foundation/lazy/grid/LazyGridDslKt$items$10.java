...
public final class LazyGridDslKt$items$10 extends C12777p implements C13090q<LazyGridItemScope, Integer, Composer, Integer, C11921v> {
    final /* synthetic */ C13090q<LazyGridItemScope, T, Composer, Integer, C11921v> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyGridDslKt$items$10(C13090q<? super LazyGridItemScope, ? super T, ? super Composer, ? super Integer, C11921v> qVar, T[] tArr) {
        super(4);
