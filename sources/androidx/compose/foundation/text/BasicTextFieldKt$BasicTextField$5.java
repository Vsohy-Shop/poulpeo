...
final class BasicTextFieldKt$BasicTextField$5 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        String str2 = str;
        BasicTextFieldKt.BasicTextField(str2, (Function1<? super String, C11921v>) this.$onValueChange, this.$modifier, this.$enabled, this.$readOnly, this.$textStyle, this.$keyboardOptions, this.$keyboardActions, this.$singleLine, this.$maxLines, this.$minLines, this.$visualTransformation, (Function1<? super TextLayoutResult, C11921v>) this.$onTextLayout, this.$interactionSource, this.$cursorBrush, (C13089p<? super C13088o<? super Composer, ? super Integer, C11921v>, ? super Composer, ? super Integer, C11921v>) this.$decorationBox, composer2, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), RecomposeScopeImplKt.updateChangedFlags(this.$$changed1), this.$$default);
    }
}
