...
/* renamed from: com.rmn.api.v2.common.model.submodel.CouponDiscount */
public class CouponDiscount implements IJsonNetworkParsable, IJsonCacheSerialisable {
    ...
    public boolean isModelValidAfterParsing() {
        if (this.amount > 0.0d && this.type != null) {
            return true;
        }
        return false;
    }
