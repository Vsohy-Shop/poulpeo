...
class FontProvider {
    private static final Comparator<byte[]> sByteArrayComparator = new C1685a();
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (columnIndex5 != -1) {
                        ...
                        i4 = Constants.MINIMAL_ERROR_STATUS_CODE;
                    }
                    ...
                    arrayList2.add(FontsContractCompat.FontInfo.create(uri, i2, i4, z, i5));
                    i6 = 0;
                }
