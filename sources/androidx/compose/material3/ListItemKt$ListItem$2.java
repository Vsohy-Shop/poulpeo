...
final class ListItemKt$ListItem$2 extends C12777p implements C13089p<RowScope, Composer, Integer, C11921v> {
    ...
    ListItemKt$ListItem$2(C13088o<? super Composer, ? super Integer, C11921v> oVar, ListItemColors listItemColors, int i, C13088o<? super Composer, ? super Integer, C11921v> oVar2, C13088o<? super Composer, ? super Integer, C11921v> oVar3, C13088o<? super Composer, ? super Integer, C11921v> oVar4) {
        super(3);
    ...
    public final void invoke(RowScope rowScope, Composer composer, int i) {
        ...
        if ((i2 & 91) != 18 || !composer.getSkipping()) {
            ...
            C13088o<Composer, Integer, C11921v> oVar3 = this.$supportingText;
            ...
            long r1 = listItemColors.headlineColor$material3_release(true, composer2, ((i3 >> 15) & 112) | 6).getValue().m35681unboximpl();
            ListTokens listTokens = ListTokens.INSTANCE;
            Composer composer3 = composer;
            ListItemKt.m34478ProvideTextStyleFromToken3JVO9M(r1, listTokens.getListItemLabelTextFont(), oVar2, composer3, ((i3 << 6) & MediaRouterJellybean.DEVICE_OUT_BLUETOOTH) | 48);
            long r12 = listItemColors.supportingColor$material3_release(composer2, (i3 >> 18) & 14).getValue().m35681unboximpl();
            TypographyKeyTokens listItemSupportingTextFont = listTokens.getListItemSupportingTextFont();
            C12775o.m28636f(oVar3);
            ListItemKt.m34478ProvideTextStyleFromToken3JVO9M(r12, listItemSupportingTextFont, oVar3, composer3, 48);
            composer.endReplaceableGroup();
            composer.endReplaceableGroup();
            composer.endReplaceableGroup();
            composer.endNode();
