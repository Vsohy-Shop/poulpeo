...
final class ProgressIndicatorKt$LinearProgressIndicator$secondLineTail$1 extends C12777p implements Function1<KeyframesSpec.KeyframesSpecConfig<Float>, C11921v> {
    ...
    public final void invoke(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
        ...
        keyframesSpecConfig.with(keyframesSpecConfig.mo4121at(Float.valueOf(0.0f), 1267), ProgressIndicatorKt.SecondLineTailEasing);
        keyframesSpecConfig.mo4121at(Float.valueOf(1.0f), 1800);
    }
}
