...
public class BarrierReference extends HelperReference {
    ...
    static /* synthetic */ class C12681 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.helpers.BarrierReference.C12681.<clinit>():void");
        }
    }
    ...
    public void apply() {
        getHelperWidget();
        int i = C12681.$SwitchMap$androidx$constraintlayout$core$state$State$Direction[this.mDirection.ordinal()];
        int i2 = 3;
        if (i == 3 || i == 4) {
            i2 = 1;
        } else if (i == 5) {
