...
final class SnackbarKt$Snackbar$4 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        SnackbarKt.m34573SnackbarsDKtq54(snackbarData2, this.$modifier, this.$actionOnNewLine, this.$shape, this.$containerColor, this.$contentColor, this.$actionColor, this.$actionContentColor, this.$dismissActionContentColor, composer2, this.$$changed | 1, this.$$default);
    }
}
