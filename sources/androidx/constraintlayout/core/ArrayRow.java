    ...
    private SolverVariable pickPivotInVariables(boolean[] zArr, SolverVariable solverVariable) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variableValue < 0.0f) {
                ...
                if ((zArr == null || !zArr[variable2.f391id]) && variable2 != solverVariable && (((type = variable2.mType) == SolverVariable.Type.SLACK || type == SolverVariable.Type.ERROR) && variableValue < f)) {
                    f = variableValue;
