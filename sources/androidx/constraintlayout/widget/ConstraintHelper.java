...
public abstract class ConstraintHelper extends View {
    ...
    private void addID(String str) {
        if (str != null && str.length() != 0 && this.myContext != null) {
            ...
            Log.w("ConstraintHelper", "Could not find id of \"" + trim + AbstractDebugRequestMapper.QUOTE);
        }
    }
    ...
    private int findId(String str) {
        ...
        if (i == 0) {
            try {
                i = C1303R.C1306id.class.getField(str).getInt((Object) null);
    ...
    public void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C1303R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = obtainStyledAttributes.getString(index);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (index == C1303R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
