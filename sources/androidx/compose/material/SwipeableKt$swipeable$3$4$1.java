...
@C12739f(mo50609c = "androidx.compose.material.SwipeableKt$swipeable$3$4$1", mo50610f = "Swipeable.kt", mo50611l = {}, mo50612m = "invokeSuspend")
...
final class SwipeableKt$swipeable$3$4$1 extends C12746l implements C13089p<C13995l0, Float, C12074d<? super C11921v>, Object> {
    ...
    @C12739f(mo50609c = "androidx.compose.material.SwipeableKt$swipeable$3$4$1$1", mo50610f = "Swipeable.kt", mo50611l = {616}, mo50612m = "invokeSuspend")
    /* renamed from: androidx.compose.material.SwipeableKt$swipeable$3$4$1$1 */
    /* compiled from: Swipeable.kt */
    static final class C07991 extends C12746l implements C13088o<C13995l0, C12074d<? super C11921v>, Object> {
        int label;

        public final C12074d<C11921v> create(Object obj, C12074d<?> dVar) {
            return new C07991(swipeableState, f, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                float f = f;
                this.label = 1;
                if (swipeableState.performFling(f, this) == c) {
                    return c;
                }
            } else if (i == 1) {
                C11910n.m25701b(obj);
        ...
        public final Object invoke(C13995l0 l0Var, C12074d<? super C11921v> dVar) {
            return ((C07991) create(l0Var, dVar)).invokeSuspend(C11921v.f18618a);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            C14054y1 unused2 = C13985j.m32422d((C13995l0) this.L$0, (C12079g) null, (C14004n0) null, new C07991((C12074d<? super C07991>) null), 3, (Object) null);
            return C11921v.f18618a;
        }
        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    }
