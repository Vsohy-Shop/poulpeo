...
public class State {
    ...
    static /* synthetic */ class C12591 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.State.C12591.<clinit>():void");
        }
    }
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference2 == null) {
            int i = C12591.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (i == 1) {
