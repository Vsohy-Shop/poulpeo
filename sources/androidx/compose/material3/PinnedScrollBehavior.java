...
final class PinnedScrollBehavior implements TopAppBarScrollBehavior {
    ...
    public PinnedScrollBehavior(TopAppBarState topAppBarState, C13074a<Boolean> aVar) {
    ...
    public /* synthetic */ PinnedScrollBehavior(TopAppBarState topAppBarState, C13074a aVar, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(topAppBarState, (i & 2) != 0 ? C08911.INSTANCE : aVar);
    }
}
