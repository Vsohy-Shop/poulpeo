...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int r6 = density.m38443roundToPx0680j_4(((TabPosition) C12686e0.m28231j0(list)).m34634getRightD9Ej5fM()) + i;
        int maxValue = r6 - this.scrollState.getMaxValue();
        return C13537l.m30886m(density.m38443roundToPx0680j_4(tabPosition.m34633getLeftD9Ej5fM()) - ((maxValue / 2) - (density.m38443roundToPx0680j_4(tabPosition.m34635getWidthD9Ej5fM()) / 2)), 0, C13537l.m30877d(r6 - maxValue, 0));
    }
