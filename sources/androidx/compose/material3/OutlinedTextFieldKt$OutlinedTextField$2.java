...
final class OutlinedTextFieldKt$OutlinedTextField$2 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1801753362, i2, -1, "androidx.compose.material3.OutlinedTextField.<anonymous> (OutlinedTextField.kt:160)");
            }
            if (this.$label != null) {
                modifier = PaddingKt.m33272paddingqDBjuR0$default(SemanticsModifierKt.semantics(this.$modifier, true, C08851.INSTANCE), 0.0f, OutlinedTextFieldKt.getOutlinedTextFieldTopPadding(), 0.0f, 0.0f, 13, (Object) null);
            } else {
            ...
            String str2 = str;
            Function1<String, C11921v> function1 = this.$onValueChange;
            ...
            Function1<String, C11921v> function12 = function1;
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer2, 794931831, true, new C13089p<C13088o<? super Composer, ? super Integer, ? extends C11921v>, Composer, Integer, C11921v>() {
                ...
                public final void invoke(C13088o<? super Composer, ? super Integer, C11921v> oVar, Composer composer, int i) {
                    ...
                    if ((i2 & 91) != 18 || !composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(794931831, i2, -1, "androidx.compose.material3.OutlinedTextField.<anonymous>.<anonymous> (OutlinedTextField.kt:188)");
                        }
                        TextFieldDefaults textFieldDefaults = TextFieldDefaults.INSTANCE;
                        String str = str3;
                        boolean z = z8;
                        ...
                        final int i4 = i7;
                        final int i5 = i8;
                        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer2, -839984881, true, new C13088o<Composer, Integer, C11921v>() {
                            public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
                                invoke((Composer) obj, ((Number) obj2).intValue());
                                return C11921v.f18618a;
                            }
                            ...
                            public final void invoke(Composer composer, int i) {
                                ...
                                if ((i2 & 11) != 2 || !composer.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-839984881, i2, -1, "androidx.compose.material3.OutlinedTextField.<anonymous>.<anonymous>.<anonymous> (OutlinedTextField.kt:203)");
                                    }
                                    TextFieldDefaults textFieldDefaults = TextFieldDefaults.INSTANCE;
                                    boolean z = z7;
                                    boolean z2 = z6;
            ...
            BasicTextFieldKt.BasicTextField(str4, (Function1) function12, modifier2, z10, z11, textStyle2, keyboardOptions2, keyboardActions2, z12, i6, visualTransformation, (Function1) null, mutableInteractionSource, (Brush) solidColor, (C13089p) composableLambda, composer, i11, i12, 2048);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
                return;
            }
