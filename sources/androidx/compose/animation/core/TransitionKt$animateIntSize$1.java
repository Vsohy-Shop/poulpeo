...
public final class TransitionKt$animateIntSize$1 extends C12777p implements C13089p<Transition.Segment<S>, Composer, Integer, SpringSpec<IntSize>> {
    ...
    public final SpringSpec<IntSize> invoke(Transition.Segment<S> segment, Composer composer, int i) {
        ...
        SpringSpec<IntSize> spring$default = AnimationSpecKt.spring$default(0.0f, 0.0f, IntSize.m38620boximpl(IntSizeKt.IntSize(1, 1)), 3, (Object) null);
