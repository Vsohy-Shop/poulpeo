...
public final class MetadataItem extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(Table.__indirect(__element(i), this.f555bb), this.f555bb);
        }
    }
    ...
    public int codepoints(int i) {
        ...
        if (__offset != 0) {
            return this.f561bb.getInt(__vector(__offset) + (i * 4));
        }
        return 0;
    }
    ...
    public short compatAdded() {
        ...
        if (__offset != 0) {
            return this.f561bb.getShort(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        if (__offset == 0 || this.f561bb.get(__offset + this.bb_pos) == 0) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: id */
    public int mo23036id() {
        int __offset = __offset(4);
        if (__offset != 0) {
            return this.f561bb.getInt(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int __offset = __offset(16);
        if (__offset != 0) {
            return intVector.__assign(__vector(__offset), this.f561bb);
        }
        return null;
    }
}
