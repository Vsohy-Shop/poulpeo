...
public final class C0450x29bde906 extends C12777p implements Function1<InspectorInfo, C11921v> {
    ...
    public C0450x29bde906(AlignmentLine alignmentLine, float f, float f2) {
        super(1);
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("before", C1232Dp.m38466boximpl(this.$before$inlined));
        inspectorInfo.getProperties().set("after", C1232Dp.m38466boximpl(this.$after$inlined));
    }
}
