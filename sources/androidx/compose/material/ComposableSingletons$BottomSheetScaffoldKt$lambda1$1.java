...
final class ComposableSingletons$BottomSheetScaffoldKt$lambda1$1 extends C12777p implements C13089p<SnackbarHostState, Composer, Integer, C11921v> {
    ...
    public final void invoke(SnackbarHostState snackbarHostState, Composer composer, int i) {
        ...
        if ((i & 91) != 18 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(895288908, i, -1, "androidx.compose.material.ComposableSingletons$BottomSheetScaffoldKt.lambda-1.<anonymous> (BottomSheetScaffold.kt:307)");
            }
