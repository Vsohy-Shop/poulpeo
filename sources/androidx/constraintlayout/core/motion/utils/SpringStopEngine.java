...
public class SpringStopEngine implements StopEngine {
    ...
    public float getAcceleration() {
        ...
        return ((float) (((-d) * (((double) this.mPos) - this.mTargetPos)) - (this.mDamping * ((double) this.f412mV)))) / this.mMass;
    }
