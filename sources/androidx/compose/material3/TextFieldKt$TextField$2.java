...
final class TextFieldKt$TextField$2 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1197699922, i2, -1, "androidx.compose.material3.TextField.<anonymous> (TextField.kt:185)");
            }
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer2, 172557367, true, new C13089p<C13088o<? super Composer, ? super Integer, ? extends C11921v>, Composer, Integer, C11921v>() {
                ...
                public final void invoke(C13088o<? super Composer, ? super Integer, C11921v> oVar, Composer composer, int i) {
                    ...
                    if ((i2 & 91) != 18 || !composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(172557367, i2, -1, "androidx.compose.material3.TextField.<anonymous>.<anonymous> (TextField.kt:205)");
                        }
                        TextFieldDefaults textFieldDefaults = TextFieldDefaults.INSTANCE;
                        String str = str2;
                        boolean z = z9;
                        ...
                        String str2 = str;
                        int i5 = i7;
                        textFieldDefaults.TextFieldDecorationBox(str2, oVar, z, z2, visualTransformation, mutableInteractionSource, z3, oVar3, oVar4, oVar5, oVar6, oVar7, shape, textFieldColors, (PaddingValues) null, (C13088o<? super Composer, ? super Integer, C11921v>) null, composer, ((i5 >> 6) & 7168) | (i4 & 14) | ((i3 << 3) & 112) | ((i4 >> 3) & MediaRouterJellybean.DEVICE_OUT_BLUETOOTH) | ((i5 << 6) & 57344) | ((i5 >> 6) & 458752) | ((i5 << 15) & 3670016) | ((i4 << 3) & 29360128) | ((i4 << 3) & 234881024) | ((i4 << 3) & 1879048192), ((i4 >> 27) & 14) | 1572864 | ((i5 << 3) & 112) | ((i5 >> 18) & MediaRouterJellybean.DEVICE_OUT_BLUETOOTH) | ((i5 >> 18) & 7168), 49152);
                        if (ComposerKt.isTraceInProgress()) {
            ...
            BasicTextFieldKt.BasicTextField(str3, (Function1) function12, modifier2, z11, z12, textStyle2, keyboardOptions2, keyboardActions2, z13, i5, visualTransformation2, (Function1) null, mutableInteractionSource, (Brush) solidColor, (C13089p) composableLambda, composer, i10, i11, 2048);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
                return;
            }
