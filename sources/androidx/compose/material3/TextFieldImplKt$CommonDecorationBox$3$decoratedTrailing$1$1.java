    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-432498573, i, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous>.<anonymous> (TextFieldImpl.kt:155)");
            }
            TextFieldImplKt.m34668DecorationKTwxG1Y(this.$trailingIconColor, (TextStyle) null, this.$it, composer, 0, 2);
            if (ComposerKt.isTraceInProgress()) {
