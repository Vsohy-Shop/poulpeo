...
public abstract class FragmentTransaction {
    ...
    static final class C2287Op {
        ...
        C2287Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C2287Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C2287Op(int i, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        addOp(new C2287Op(i2, fragment));
    }

    @NonNull
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        addOp(new C2287Op(4, fragment));
        return this;
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        addOp(new C2287Op(10, fragment, state));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C2287Op(8, fragment));
        return this;
    }
    ...
    FragmentTransaction(@NonNull FragmentFactory fragmentFactory, @Nullable ClassLoader classLoader, @NonNull FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C2287Op> it = fragmentTransaction.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new C2287Op(it.next()));
        }
