...
public final class LazyDslKt$itemsIndexed$4 extends C12777p implements C13090q<LazyItemScope, Integer, Composer, Integer, C11921v> {
    final /* synthetic */ C13091r<LazyItemScope, Integer, T, Composer, Integer, C11921v> $itemContent;
    final /* synthetic */ List<T> $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyDslKt$itemsIndexed$4(C13091r<? super LazyItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, C11921v> rVar, List<? extends T> list) {
        super(4);
