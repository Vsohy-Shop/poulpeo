...
final class ExposedDropdownMenuKt$ExposedDropdownMenuBox$3$listener$1 extends C12777p implements C13074a<C11921v> {
    ...
    public final void invoke() {
        ...
        ExposedDropdownMenuKt.updateHeight(rootView, this.$coordinates.getValue(), i, new Function1<Integer, C11921v>() {
            ...
            public final void invoke(int i) {
                ExposedDropdownMenuKt.m34422ExposedDropdownMenuBox$lambda5(mutableState, i);
            }
        });
    }
}
