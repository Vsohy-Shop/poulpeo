...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    static /* synthetic */ class C12865 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f432xabc7e4ac     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f432xabc7e4ac     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f432xabc7e4ac     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.motion.widget.MotionLayout.C12865.<clinit>():void");
        }
    }
    ...
    class Model {
        ...
        public void measure(int i, int i2) {
            ...
            if (z) {
                ...
                motionLayout2.mMeasureDuringTransition = z4;
            }
            MotionLayout motionLayout3 = MotionLayout.this;
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1303R.styleable.MotionLayout);
            int indexCount = obtainStyledAttributes.getIndexCount();
            boolean z = true;
            for (int i2 = 0; i2 < indexCount; i2++) {
                int index = obtainStyledAttributes.getIndex(i2);
                if (index == C1303R.styleable.MotionLayout_layoutDescription) {
                    this.mScene = new MotionScene(getContext(), this, obtainStyledAttributes.getResourceId(index, -1));
                } else if (index == C1303R.styleable.MotionLayout_currentState) {
                    this.mCurrentState = obtainStyledAttributes.getResourceId(index, -1);
                } else if (index == C1303R.styleable.MotionLayout_motionProgress) {
                    this.mTransitionGoalPosition = obtainStyledAttributes.getFloat(index, 0.0f);
                    this.mInTransition = true;
                } else if (index == C1303R.styleable.MotionLayout_applyMotionScene) {
                    z = obtainStyledAttributes.getBoolean(index, z);
                } else if (index == C1303R.styleable.MotionLayout_showPaths) {
                ...
                } else if (index == C1303R.styleable.MotionLayout_motionDebug) {
    ...
    public void setState(TransitionState transitionState) {
        ...
        if (transitionState != transitionState2 || this.mCurrentState != -1) {
            ...
            int i = C12865.f432xabc7e4ac[transitionState3.ordinal()];
            if (i == 1 || i == 2) {
    ...
    public void updateStateAnimate(int i, ConstraintSet constraintSet, int i2) {
        if (this.mScene != null && this.mCurrentState == i) {
            int i3 = C1303R.C1306id.view_transition;
    ...
    private static class MyTracker implements MotionTracker {
        ...
        /* renamed from: me */
        private static MyTracker f433me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f433me.tracker = VelocityTracker.obtain();
            return f433me;
        }
