    ...
    private static void encodeUtf8Buffer(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i2 < length) {
            ...
            if (charAt2 < 128) {
                ...
                i = position + 1;
                byteBuffer.put(position, (byte) ((charAt2 >>> 12) | OAuthErrorCodes.ERR_OAUTH_INVALID_CONSUMER));
                position = i + 1;
                ...
                if (i3 != length) {
                    try {
                        ...
                        if (Character.isSurrogatePair(charAt2, charAt3)) {
                            ...
                            int i4 = position + 1;
                            try {
                                byteBuffer.put(position, (byte) ((codePoint >>> 18) | OAuthErrorCodes.ERR_OAUTH_HEADERS));
                                position = i4 + 1;
