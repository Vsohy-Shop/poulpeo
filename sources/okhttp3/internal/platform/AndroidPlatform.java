...
public final class AndroidPlatform extends Platform {
    ...
    public static final class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public CustomTrustRootIndex(X509TrustManager x509TrustManager, Method method) {
            ...
            C12775o.m28639i(method, "findByIssuerAndSignatureMethod");
        ...
        public boolean equals(Object obj) {
            ...
            if (C12775o.m28634d(this.trustManager, customTrustRootIndex.trustManager) && C12775o.m28634d(this.findByIssuerAndSignatureMethod, customTrustRootIndex.findByIssuerAndSignatureMethod)) {
                return true;
            }
            return false;
        }
        ...
        public X509Certificate findByIssuerAndSignature(X509Certificate x509Certificate) {
            C12775o.m28639i(x509Certificate, "cert");
            try {
    ...
    public TrustRootIndex buildTrustRootIndex(X509TrustManager x509TrustManager) {
        ...
        try {
            ...
            C12775o.m28638h(declaredMethod, "method");
