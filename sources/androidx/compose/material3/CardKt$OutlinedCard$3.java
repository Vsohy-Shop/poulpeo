...
final class CardKt$OutlinedCard$3 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    CardKt$OutlinedCard$3(C13074a<C11921v> aVar, Modifier modifier, boolean z, Shape shape, CardColors cardColors, CardElevation cardElevation, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, C13089p<? super ColumnScope, ? super Composer, ? super Integer, C11921v> pVar, int i, int i2) {
        super(2);
        this.$onClick = aVar;
