...
final class SliderKt$Slider$4 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    SliderKt$Slider$4(float f, Function1<? super Float, C11921v> function1, Modifier modifier, boolean z, C13522b<Float> bVar, int i, C13074a<C11921v> aVar, MutableInteractionSource mutableInteractionSource, SliderColors sliderColors, int i2, int i3) {
        super(2);
        this.$value = f;
