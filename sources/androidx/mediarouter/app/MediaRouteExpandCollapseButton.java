...
class MediaRouteExpandCollapseButton extends AppCompatImageButton {
    ...
    public MediaRouteExpandCollapseButton(Context context, AttributeSet attributeSet, int i) {
        ...
        AnimationDrawable animationDrawable = (AnimationDrawable) ContextCompat.getDrawable(context, C2410R.C2412drawable.mr_group_expand);
        this.mExpandAnimationDrawable = animationDrawable;
        AnimationDrawable animationDrawable2 = (AnimationDrawable) ContextCompat.getDrawable(context, C2410R.C2412drawable.mr_group_collapse);
        ...
        String string = context.getString(C2410R.string.mr_controller_expand_group);
        this.mExpandGroupDescription = string;
        this.mCollapseGroupDescription = context.getString(C2410R.string.mr_controller_collapse_group);
