...
public final class C10824a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f16582a;

    /* renamed from: b */
    private static final Map<Integer, String> f16583b;
    ...
    /* renamed from: a */
    public static String m23079a(int i) {
        Map<Integer, String> map = f16582a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        String str = map.get(valueOf);
        String str2 = f16583b.get(valueOf);
