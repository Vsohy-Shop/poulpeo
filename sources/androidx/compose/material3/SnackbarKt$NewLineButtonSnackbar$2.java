...
final class SnackbarKt$NewLineButtonSnackbar$2 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    SnackbarKt$NewLineButtonSnackbar$2(C13088o<? super Composer, ? super Integer, C11921v> oVar, C13088o<? super Composer, ? super Integer, C11921v> oVar2, C13088o<? super Composer, ? super Integer, C11921v> oVar3, TextStyle textStyle, long j, long j2, int i) {
        super(2);
        this.$text = oVar;
        this.$action = oVar2;
    ...
    public final void invoke(Composer composer, int i) {
        SnackbarKt.m34570NewLineButtonSnackbarkKq0p4A(this.$text, this.$action, this.$dismissAction, this.$actionTextStyle, this.$actionContentColor, this.$dismissActionContentColor, composer, this.$$changed | 1);
    }
}
