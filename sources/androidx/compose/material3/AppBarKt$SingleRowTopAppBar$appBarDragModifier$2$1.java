...
@C12739f(mo50609c = "androidx.compose.material3.AppBarKt$SingleRowTopAppBar$appBarDragModifier$2$1", mo50610f = "AppBar.kt", mo50611l = {1031}, mo50612m = "invokeSuspend")
/* compiled from: AppBar.kt */
final class AppBarKt$SingleRowTopAppBar$appBarDragModifier$2$1 extends C12746l implements C13089p<C13995l0, Float, C12074d<? super C11921v>, Object> {
    final /* synthetic */ TopAppBarScrollBehavior $scrollBehavior;
    /* synthetic */ float F$0;
    int label;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppBarKt$SingleRowTopAppBar$appBarDragModifier$2$1(TopAppBarScrollBehavior topAppBarScrollBehavior, C12074d<? super AppBarKt$SingleRowTopAppBar$appBarDragModifier$2$1> dVar) {
        super(3, dVar);
    ...
    public final Object invoke(C13995l0 l0Var, float f, C12074d<? super C11921v> dVar) {
        ...
        return appBarKt$SingleRowTopAppBar$appBarDragModifier$2$1.invokeSuspend(C11921v.f18618a);
    }
}
