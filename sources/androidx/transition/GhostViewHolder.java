...
class GhostViewHolder extends FrameLayout {
    ...
    GhostViewHolder(ViewGroup viewGroup) {
        ...
        viewGroup.setTag(C2674R.C2677id.ghost_view_holder, this);
        ViewGroupUtils.getOverlay(this.mParent).add(this);
    }

    static GhostViewHolder getHolder(@NonNull ViewGroup viewGroup) {
        return (GhostViewHolder) viewGroup.getTag(C2674R.C2677id.ghost_view_holder);
    }
    ...
    public void onViewRemoved(View view) {
        ...
        if ((getChildCount() == 1 && getChildAt(0) == view) || getChildCount() == 0) {
            this.mParent.setTag(C2674R.C2677id.ghost_view_holder, (Object) null);
