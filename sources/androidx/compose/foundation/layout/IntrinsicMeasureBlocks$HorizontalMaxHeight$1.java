...
final class IntrinsicMeasureBlocks$HorizontalMaxHeight$1 extends C12777p implements C13089p<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> {
    ...
    public final Integer invoke(List<? extends IntrinsicMeasurable> list, int i, int i2) {
        ...
        return Integer.valueOf(RowColumnImplKt.intrinsicSize(list, C04521.INSTANCE, C04532.INSTANCE, i, i2, LayoutOrientation.Horizontal, LayoutOrientation.Vertical));
    }
}
