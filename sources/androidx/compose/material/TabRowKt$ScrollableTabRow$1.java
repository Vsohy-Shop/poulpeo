...
final class TabRowKt$ScrollableTabRow$1 extends C12777p implements C13089p<List<? extends TabPosition>, Composer, Integer, C11921v> {
    ...
    public final void invoke(List<TabPosition> list, Composer composer, int i) {
        ...
        tabRowDefaults.m34165Indicator9IZ8Weo(tabRowDefaults.tabIndicatorOffset(Modifier.Companion, list.get(this.$selectedTabIndex)), 0.0f, 0, composer, 3072, 6);
        if (ComposerKt.isTraceInProgress()) {
