...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    @AttrRes
    private static final int DEF_STYLE_ATTR = C6372R.attr.alertDialogStyle;
    @StyleRes
    private static final int DEF_STYLE_RES = C6372R.C6378style.MaterialAlertDialog_MaterialComponents;
    @AttrRes
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C6372R.attr.materialAlertDialogTheme;
    @Nullable
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetBottom(@C0127Px int i) {
        this.backgroundInsets.bottom = i;
        return this;
    }

    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetEnd(@C0127Px int i) {
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetStart(@C0127Px int i) {
        if (getContext().getResources().getConfiguration().getLayoutDirection() == 1) {
            this.backgroundInsets.right = i;
        } else {
            this.backgroundInsets.left = i;
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetTop(@C0127Px int i) {
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C6372R.attr.colorSurface, getClass().getCanonicalName());
