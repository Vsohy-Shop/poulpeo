...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    private interface SuperCaller {
        ...
        void setFirstBaselineToTopHeight(@C0127Px int i);

        void setLastBaselineToBottomHeight(@C0127Px int i);
    ...
    class SuperCallerApi28 extends SuperCallerApi26 {
        ...
        public void setFirstBaselineToTopHeight(@C0127Px int i) {
            AppCompatTextView.super.setFirstBaselineToTopHeight(i);
        }

        public void setLastBaselineToBottomHeight(@C0127Px int i) {
    ...
    public void setFirstBaselineToTopHeight(@C0127Px @IntRange(from = 0) int i) {
    ...
    public void setLastBaselineToBottomHeight(@C0127Px @IntRange(from = 0) int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    public void setLineHeight(@C0127Px @IntRange(from = 0) int i) {
