...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C2287Op op = this.mOps.get(i2);
    ...
    public void collapseOps() {
        ...
        while (size >= 0) {
            FragmentTransaction.C2287Op op = this.mOps.get(size);
            if (op.mFromExpandedOp) {
                if (op.mCmd == 8) {
                    ...
                    for (int i2 = size - 1; i2 >= 0; i2--) {
                        FragmentTransaction.C2287Op op2 = this.mOps.get(i2);
    ...
    public void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C2287Op op = this.mOps.get(i);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment4.mContainerId == i3) {
                            if (fragment4 == fragment3) {
                                ...
                                if (fragment4 == fragment2) {
                                    this.mOps.add(i, new FragmentTransaction.C2287Op(9, fragment4, true));
                                    i++;
                                    fragment2 = null;
                                }
                                FragmentTransaction.C2287Op op2 = new FragmentTransaction.C2287Op(3, fragment4, true);
                    ...
                    if (fragment5 == fragment2) {
                        this.mOps.add(i, new FragmentTransaction.C2287Op(9, fragment5));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        this.mOps.add(i, new FragmentTransaction.C2287Op(9, fragment2, true));
                        op.mFromExpandedOp = true;
                        i++;
