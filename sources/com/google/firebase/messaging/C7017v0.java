...
class C7017v0 {
    ...
    /* renamed from: b */
    private final Map<String, Task<String>> f9361b = new ArrayMap();
    ...
    public synchronized com.google.android.gms.tasks.Task<java.lang.String> mo39991a(java.lang.String r4, com.google.firebase.messaging.C7017v0.C7018a r5) {
        /*
            r3 = this;
            monitor-enter(r3)
            java.util.Map<java.lang.String, com.google.android.gms.tasks.Task<java.lang.String>> r0 = r3.f9361b     // Catch:{ all -> 0x006a }
        ...
        L_0x0054:
            ...
            java.util.concurrent.Executor r0 = r3.f9360a     // Catch:{ all -> 0x006a }
            com.google.firebase.messaging.u0 r1 = new com.google.firebase.messaging.u0     // Catch:{ all -> 0x006a }
            r1.<init>(r3, r4)     // Catch:{ all -> 0x006a }
            com.google.android.gms.tasks.Task r5 = r5.mo35459j(r0, r1)     // Catch:{ all -> 0x006a }
            java.util.Map<java.lang.String, com.google.android.gms.tasks.Task<java.lang.String>> r0 = r3.f9361b     // Catch:{ all -> 0x006a }
        ...
        L_0x006a:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.messaging.C7017v0.mo39991a(java.lang.String, com.google.firebase.messaging.v0$a):com.google.android.gms.tasks.Task");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public /* synthetic */ Task mo39992b(String str, Task task) {
        synchronized (this) {
            this.f9361b.remove(str);
        }
        return task;
    }
}
