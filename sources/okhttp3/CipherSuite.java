...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (C13754v.m31525E(str, "TLS_", false, 2, (Object) null)) {
                String substring = str.substring(4);
                C12775o.m28638h(substring, "this as java.lang.String).substring(startIndex)");
                return C12775o.m28647q("SSL_", substring);
            } else if (!C13754v.m31525E(str, "SSL_", false, 2, (Object) null)) {
                return str;
            } else {
                String substring2 = str.substring(4);
                C12775o.m28638h(substring2, "this as java.lang.String).substring(startIndex)");
                return C12775o.m28647q("TLS_", substring2);
            }
        }
    ...
    public final String m38767deprecated_javaName() {
