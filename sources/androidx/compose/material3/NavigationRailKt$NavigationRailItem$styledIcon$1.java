...
final class NavigationRailKt$NavigationRailItem$styledIcon$1 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    NavigationRailKt$NavigationRailItem$styledIcon$1(NavigationRailItemColors navigationRailItemColors, boolean z, int i, C13088o<? super Composer, ? super Integer, C11921v> oVar, boolean z2, C13088o<? super Composer, ? super Integer, C11921v> oVar2) {
        super(2);
    ...
    private static final long m34530invoke$lambda0(State<Color> state) {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier clearAndSetSemantics = this.$label != null && (this.$alwaysShowLabel || this.$selected) ? SemanticsModifierKt.clearAndSetSemantics(Modifier.Companion, C08831.INSTANCE) : Modifier.Companion;
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m35661boximpl(m34530invoke$lambda0(iconColor$material3_release)))}, (C13088o<? super Composer, ? super Integer, C11921v>) oVar, composer, ((i3 >> 3) & 112) | 8);
