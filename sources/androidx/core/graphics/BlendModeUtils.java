...
class BlendModeUtils {
    ...
    static /* synthetic */ class C15591 {
        ...
        static {
            ...
            L_0x015c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.BlendModeUtils.C15591.<clinit>():void");
        }
    }
    ...
    static class Api29Impl {
        ...
        static Object obtainBlendModeFromCompat(@NonNull BlendModeCompat blendModeCompat) {
            switch (C15591.$SwitchMap$androidx$core$graphics$BlendModeCompat[blendModeCompat.ordinal()]) {
                case 1:
