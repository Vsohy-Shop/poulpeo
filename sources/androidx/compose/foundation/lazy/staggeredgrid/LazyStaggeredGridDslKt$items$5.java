...
public final class LazyStaggeredGridDslKt$items$5 extends C12777p implements C13090q<LazyStaggeredGridItemScope, Integer, Composer, Integer, C11921v> {
    final /* synthetic */ C13090q<LazyStaggeredGridItemScope, T, Composer, Integer, C11921v> $itemContent;
    final /* synthetic */ List<T> $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyStaggeredGridDslKt$items$5(C13090q<? super LazyStaggeredGridItemScope, ? super T, ? super Composer, ? super Integer, C11921v> qVar, List<? extends T> list) {
        super(4);
