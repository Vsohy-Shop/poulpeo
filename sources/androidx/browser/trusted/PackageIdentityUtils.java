    ...
    static class Api28Implementation implements SignaturesCompat {
        ...
        public List<byte[]> getFingerprintsForPackage(String str, PackageManager packageManager) {
            ...
            if (a.hasMultipleSigners()) {
                for (Signature certificateSHA256Fingerprint : a.getApkContentsSigners()) {
                    arrayList.add(PackageIdentityUtils.getCertificateSHA256Fingerprint(certificateSHA256Fingerprint));
                }
            } else {
                arrayList.add(PackageIdentityUtils.getCertificateSHA256Fingerprint(a.getSigningCertificateHistory()[0]));
            }
            return arrayList;
        }
