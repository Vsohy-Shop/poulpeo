...
import androidx.swiperefreshlayout.C2632R;
...
class CircleImageView extends ImageView {
    ...
    CircleImageView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(C2632R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = obtainStyledAttributes.getColor(C2632R.styleable.f1094xaa980688, DEFAULT_BACKGROUND_COLOR);
