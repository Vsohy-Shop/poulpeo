...
class RadialViewGroup extends ConstraintLayout {
    ...
    public void updateLayoutParams() {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            int i4 = C6372R.C6375id.circle_center;
    ...
    public RadialViewGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C6372R.C6377layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C6372R.styleable.RadialViewGroup, i, 0);
        this.radius = obtainStyledAttributes.getDimensionPixelSize(C6372R.styleable.RadialViewGroup_materialCircleRadius, 0);
        this.updateLayoutParametersRunnable = new C6636a(this);
