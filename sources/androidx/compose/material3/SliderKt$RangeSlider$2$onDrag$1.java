...
final class SliderKt$RangeSlider$2$onDrag$1 extends C12777p implements C13088o<Boolean, Float, C11921v> {
    ...
    SliderKt$RangeSlider$2$onDrag$1(MutableState<Float> mutableState, MutableState<Float> mutableState2, C13522b<Float> bVar, C12757e0 e0Var, float[] fArr, C12757e0 e0Var2, State<? extends Function1<? super C13522b<Float>, C11921v>> state, C13522b<Float> bVar2) {
        super(2);
    ...
    public final void invoke(boolean z, float f) {
        ...
        if (z) {
            ...
            bVar = C13536k.m30875b(SliderKt.snapValueToTick(C13537l.m30885l(this.$rawOffsetStart.getValue().floatValue(), this.$minPx.f20408b, floatValue), this.$tickFractions, this.$minPx.f20408b, this.$maxPx.f20408b), floatValue);
        } else {
            ...
            bVar = C13536k.m30875b(floatValue2, SliderKt.snapValueToTick(C13537l.m30885l(this.$rawOffsetEnd.getValue().floatValue(), floatValue2, this.$maxPx.f20408b), this.$tickFractions, this.$minPx.f20408b, this.$maxPx.f20408b));
        }
