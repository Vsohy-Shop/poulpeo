...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    static /* synthetic */ class C26077 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f1089x3d106619     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.C26077.<clinit>():void");
        }
    }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public boolean canRestoreState() {
            int i = C26077.f1089x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i == 1) {
                return false;
            }
            if (i != 2) {
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C26081 r0 = new ViewBoundsCheck.Callback() {
            ...
            C26092 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2560R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C2560R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C2560R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C2560R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C2560R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void offsetChildrenHorizontal(@C0127Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@C0127Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@C0127Px int i, @C0127Px int i2) {
            ...
            public void setDx(@C0127Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }

            public void setDy(@C0127Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0127Px int i, @C0127Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
            ...
            public Action(@C0127Px int i, @C0127Px int i2, int i3) {
                this(i, i2, i3, (Interpolator) null);
            }

            public Action(@C0127Px int i, @C0127Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mJumpToPosition = -1;
                this.mChanged = false;
                this.mConsecutiveUpdates = 0;
                this.mDx = i;
        ...
        /* access modifiers changed from: protected */
        public abstract void onSeekTargetStep(@C0127Px int i, @C0127Px int i2, @NonNull State state, @NonNull Action action);
    ...
    class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i2) {
            ...
            return Math.min((int) (((((float) abs) / ((float) i3)) + 1.0f) * 300.0f), RecyclerView.MAX_SCROLL_DURATION);
        }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C2560R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C2560R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C2560R.dimen.fastscroll_margin));
    }
    ...
    public void smoothScrollBy(@C0127Px int i, @C0127Px int i2) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2560R.attr.recyclerViewStyle);
    }
    ...
    public void smoothScrollBy(@C0127Px int i, @C0127Px int i2, @Nullable Interpolator interpolator) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C2560R.styleable.RecyclerView;
        ...
        String string = obtainStyledAttributes.getString(C2560R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C2560R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C2560R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = obtainStyledAttributes.getBoolean(C2560R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C2560R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C2560R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C2560R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C2560R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        obtainStyledAttributes.recycle();
    ...
    public void smoothScrollBy(@C0127Px int i, @C0127Px int i2, @Nullable Interpolator interpolator, int i3) {
    ...
    /* access modifiers changed from: package-private */
    public void smoothScrollBy(@C0127Px int i, @C0127Px int i2, @Nullable Interpolator interpolator, int i3, boolean z) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutSuppressed) {
    ...
    public void onScrolled(@C0127Px int i, @C0127Px int i2) {
    }
}
