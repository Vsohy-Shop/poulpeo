...
public final class AndroidView_androidKt$AndroidView$$inlined$ComposeNode$1 extends C12777p implements C13074a<LayoutNode> {
    final /* synthetic */ C13074a $factory;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AndroidView_androidKt$AndroidView$$inlined$ComposeNode$1(C13074a aVar) {
        super(0);
        this.$factory = aVar;
    }
