...
class TouchResponse {
    ...
    private void fill(TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == C1303R.styleable.OnSwipe_touchAnchorId) {
                this.mTouchAnchorId = typedArray.getResourceId(index, this.mTouchAnchorId);
            } else if (index == C1303R.styleable.OnSwipe_touchAnchorSide) {
            ...
            } else if (index == C1303R.styleable.OnSwipe_dragDirection) {
    ...
    private void fillFromAttributeList(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1303R.styleable.OnSwipe);
