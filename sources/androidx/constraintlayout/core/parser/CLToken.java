...
public class CLToken extends CLElement {
    ...
    static /* synthetic */ class C12571 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.parser.CLToken.C12571.<clinit>():void");
        }
    }
    ...
    public boolean validate(char c, long j) {
        int i = C12571.$SwitchMap$androidx$constraintlayout$core$parser$CLToken$Type[this.type.ordinal()];
        boolean z = false;
        if (i == 1) {
