...
public final class LazyGridDslKt$itemsIndexed$10 extends C12777p implements C13090q<LazyGridItemScope, Integer, Composer, Integer, C11921v> {
    final /* synthetic */ C13091r<LazyGridItemScope, Integer, T, Composer, Integer, C11921v> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyGridDslKt$itemsIndexed$10(C13091r<? super LazyGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, C11921v> rVar, T[] tArr) {
        super(4);
