...
final class RadioButtonKt$RadioButton$3 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    RadioButtonKt$RadioButton$3(boolean z, C13074a<C11921v> aVar, Modifier modifier, boolean z2, MutableInteractionSource mutableInteractionSource, RadioButtonColors radioButtonColors, int i, int i2) {
        super(2);
        this.$selected = z;
        this.$onClick = aVar;
