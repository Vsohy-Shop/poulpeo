...
public final class DiskLruCache implements Closeable {
    ...
    public static final C13175w0 NULL_SINK = new C13175w0() {
    ...
    public final class Editor {
        ...
        public C13179y0 newSource(int i) {
            synchronized (DiskLruCache.this) {
                if (this.entry.currentEditor != this) {
                    throw new IllegalStateException();
                    ...
                    try {
                        C13179y0 source = DiskLruCache.this.fileSystem.source(this.entry.cleanFiles[i]);
                        return source;
                    } catch (FileNotFoundException unused) {
                        return null;
                    }
    ...
    private final class Entry {
        ...
        public Snapshot snapshot() {
            ...
            if (Thread.holdsLock(DiskLruCache.this)) {
                C13179y0[] y0VarArr = new C13179y0[DiskLruCache.this.valueCount];
                long[] jArr = (long[]) this.lengths.clone();
                int i = 0;
                int i2 = 0;
                while (i2 < DiskLruCache.this.valueCount) {
                    try {
                        y0VarArr[i2] = DiskLruCache.this.fileSystem.source(this.cleanFiles[i2]);
                        i2++;
                    } catch (FileNotFoundException unused) {
                        while (i < DiskLruCache.this.valueCount && (y0Var = y0VarArr[i]) != null) {
                ...
                return new Snapshot(this.key, this.sequenceNumber, y0VarArr, jArr);
            }
            throw new AssertionError();
        }

        /* access modifiers changed from: package-private */
        public void writeLengths(C13127d dVar) {
            for (long o0 : this.lengths) {
    ...
    public final class Snapshot implements Closeable {
        ...
        private final C13179y0[] sources;
        ...
        public C13179y0 getSource(int i) {
        ...
        private Snapshot(String str, long j, C13179y0[] y0VarArr, long[] jArr) {
            this.key = str;
            this.sequenceNumber = j;
            this.sources = y0VarArr;
            this.lengths = jArr;
        }
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void completeEdit(com.squareup.okhttp.internal.DiskLruCache.Editor r10, boolean r11) {
        /*
            r9 = this;
            monitor-enter(r9)
        ...
        L_0x0091:
            ...
            okio.d r10 = r9.journalWriter     // Catch:{ all -> 0x0118 }
            java.lang.String r1 = "CLEAN"
            okio.d r10 = r10.mo52486F(r1)     // Catch:{ all -> 0x0118 }
            r10.writeByte(r3)     // Catch:{ all -> 0x0118 }
            okio.d r10 = r9.journalWriter     // Catch:{ all -> 0x0118 }
            java.lang.String r1 = r0.key     // Catch:{ all -> 0x0118 }
            r10.mo52486F(r1)     // Catch:{ all -> 0x0118 }
            okio.d r10 = r9.journalWriter     // Catch:{ all -> 0x0118 }
        ...
        L_0x00d4:
            ...
            okio.d r10 = r10.mo52486F(r11)     // Catch:{ all -> 0x0118 }
            r10.writeByte(r3)     // Catch:{ all -> 0x0118 }
            okio.d r10 = r9.journalWriter     // Catch:{ all -> 0x0118 }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x0118 }
            r10.mo52486F(r11)     // Catch:{ all -> 0x0118 }
            okio.d r10 = r9.journalWriter     // Catch:{ all -> 0x0118 }
            r10.writeByte(r2)     // Catch:{ all -> 0x0118 }
        L_0x00f6:
            okio.d r10 = r9.journalWriter     // Catch:{ all -> 0x0118 }
    ...
    private C13127d newJournalWriter() {
        return C13145j0.m29738c(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
            static final /* synthetic */ boolean $assertionsDisabled = false;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x006a, code lost:
        if (r1.mo52552t() == false) goto L_0x006c;
     */
    ...
    private void readJournal() {
        /*
            ...
            java.lang.String r2 = r1.mo52507U()     // Catch:{ all -> 0x00a8 }
            java.lang.String r3 = r1.mo52507U()     // Catch:{ all -> 0x00a8 }
            java.lang.String r4 = r1.mo52507U()     // Catch:{ all -> 0x00a8 }
            java.lang.String r5 = r1.mo52507U()     // Catch:{ all -> 0x00a8 }
            java.lang.String r6 = r1.mo52507U()     // Catch:{ all -> 0x00a8 }
            ...
            r0 = 0
        L_0x0053:
            java.lang.String r2 = r1.mo52507U()     // Catch:{ EOFException -> 0x005d }
        ...
        L_0x005d:
            ...
            boolean r0 = r1.mo52552t()     // Catch:{ all -> 0x00a8 }
            if (r0 != 0) goto L_0x0070
            r9.rebuildJournal()     // Catch:{ all -> 0x00a8 }
            goto L_0x0076
        L_0x0070:
            okio.d r0 = r9.newJournalWriter()     // Catch:{ all -> 0x00a8 }
    ...
    public synchronized void rebuildJournal() {
        ...
        C13127d c = C13145j0.m29738c(this.fileSystem.sink(this.journalFileTmp));
        try {
            c.mo52486F(MAGIC).writeByte(10);
            c.mo52486F(VERSION_1).writeByte(10);
            c.mo52535o0((long) this.appVersion).writeByte(10);
            c.mo52535o0((long) this.valueCount).writeByte(10);
            c.writeByte(10);
            for (Entry next : this.lruEntries.values()) {
                if (next.currentEditor != null) {
                    c.mo52486F(DIRTY).writeByte(32);
                    c.mo52486F(next.key);
                    c.writeByte(10);
                } else {
                    c.mo52486F(CLEAN).writeByte(32);
                    c.mo52486F(next.key);
                    next.writeLengths(c);
                    c.writeByte(10);
                }
    ...
    public boolean removeEntry(Entry entry) {
        ...
        this.journalWriter.mo52486F(REMOVE).writeByte(32).mo52486F(entry.key).writeByte(10);
    ...
    public synchronized com.squareup.okhttp.internal.DiskLruCache.Snapshot get(java.lang.String r4) {
        ...
        L_0x0024:
            ...
            okio.d r1 = r3.journalWriter     // Catch:{ all -> 0x0052 }
            java.lang.String r2 = "READ"
            okio.d r1 = r1.mo52486F(r2)     // Catch:{ all -> 0x0052 }
            r2 = 32
            okio.d r1 = r1.writeByte(r2)     // Catch:{ all -> 0x0052 }
            okio.d r4 = r1.mo52486F(r4)     // Catch:{ all -> 0x0052 }
            r1 = 10
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized com.squareup.okhttp.internal.DiskLruCache.Editor edit(java.lang.String r6, long r7) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x0025:
            ...
            return r2
        L_0x002f:
            okio.d r7 = r5.journalWriter     // Catch:{ all -> 0x0067 }
            java.lang.String r8 = "DIRTY"
            okio.d r7 = r7.mo52486F(r8)     // Catch:{ all -> 0x0067 }
            r8 = 32
            okio.d r7 = r7.writeByte(r8)     // Catch:{ all -> 0x0067 }
            okio.d r7 = r7.mo52486F(r6)     // Catch:{ all -> 0x0067 }
            r8 = 10
