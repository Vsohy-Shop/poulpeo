...
final class OutlinedTextFieldKt$OutlinedTextField$3 extends C12777p implements C13089p<C13088o<? super Composer, ? super Integer, ? extends C11921v>, Composer, Integer, C11921v> {
    ...
    public final void invoke(C13088o<? super Composer, ? super Integer, C11921v> oVar, Composer composer, int i) {
        ...
        if ((i2 & 91) != 18 || !composer.getSkipping()) {
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer2, -1823843281, true, new C13088o<Composer, Integer, C11921v>() {
                ...
                public final void invoke(Composer composer, int i) {
                    ...
                    if ((i2 & 11) != 2 || !composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1823843281, i2, -1, "androidx.compose.material.OutlinedTextField.<anonymous>.<anonymous> (OutlinedTextField.kt:204)");
                        }
                        TextFieldDefaults textFieldDefaults = TextFieldDefaults.INSTANCE;
                        boolean z = z7;
                        boolean z2 = z6;
            ...
            int i5 = this.$$dirty;
            int i6 = (i5 & 14) | ((i2 << 3) & 112) | ((i5 >> 3) & MediaRouterJellybean.DEVICE_OUT_BLUETOOTH);
            int i7 = this.$$dirty1;
            textFieldDefaults2.OutlinedTextFieldDecorationBox(str2, oVar, z2, z3, visualTransformation, mutableInteractionSource2, z5, oVar3, oVar4, oVar5, oVar6, textFieldColors2, (PaddingValues) null, composableLambda, composer, i6 | ((i7 >> 3) & 7168) | ((i7 << 9) & 57344) | ((i7 >> 6) & 458752) | ((i7 << 18) & 3670016) | ((i5 << 3) & 29360128) | ((i5 << 3) & 234881024) | ((i5 << 3) & 1879048192), ((i5 >> 27) & 14) | 27648 | ((i7 >> 24) & 112), 4096);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
                return;
            }
