...
/* renamed from: com.google.android.gms.internal.gtm.h8 */
public final class C5371h8 extends C5521r5 {
    ...
    public final C5528rc<?> mo33099b(C5276b4 b4Var, C5528rc<?>... rcVarArr) {
        ...
        return new C5589vc(Double.valueOf((double) str.indexOf(g, (int) Math.min(Math.max(d, 0.0d), (double) str.length()))));
    }
}
