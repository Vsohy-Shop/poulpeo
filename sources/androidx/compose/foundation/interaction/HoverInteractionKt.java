...
public final class HoverInteractionKt {
    ...
    public static final State<Boolean> collectIsHoveredAsState(InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (changed || rememberedValue2 == companion.getEmpty()) {
            rememberedValue2 = new HoverInteractionKt$collectIsHoveredAsState$1$1(interactionSource, mutableState, (C12074d<? super HoverInteractionKt$collectIsHoveredAsState$1$1>) null);
