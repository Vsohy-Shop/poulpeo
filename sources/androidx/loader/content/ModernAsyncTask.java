...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static /* synthetic */ class C23654 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.loader.content.ModernAsyncTask.C23654.<clinit>():void");
        }
    }
    ...
    ModernAsyncTask() {
        C23632 r0 = new WorkerRunnable<Params, Result>() {
            public Result call() {
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            int i = C23654.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
            if (i == 1) {
