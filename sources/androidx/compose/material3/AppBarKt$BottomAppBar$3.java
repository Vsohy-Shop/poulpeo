...
final class AppBarKt$BottomAppBar$3 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    AppBarKt$BottomAppBar$3(WindowInsets windowInsets, PaddingValues paddingValues, C13089p<? super RowScope, ? super Composer, ? super Integer, C11921v> pVar, int i) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-396569832, i, -1, "androidx.compose.material3.BottomAppBar.<anonymous> (AppBar.kt:469)");
            }
            Modifier padding = PaddingKt.padding(SizeKt.m33324height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), this.$windowInsets), BottomAppBarTokens.INSTANCE.m34779getContainerHeightD9Ej5fM()), this.$contentPadding);
