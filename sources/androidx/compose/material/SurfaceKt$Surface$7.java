...
final class SurfaceKt$Surface$7 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    SurfaceKt$Surface$7(Modifier modifier, Shape shape, long j, float f, int i, BorderStroke borderStroke, float f2, boolean z, MutableInteractionSource mutableInteractionSource, boolean z2, C13074a<C11921v> aVar, C13088o<? super Composer, ? super Integer, C11921v> oVar, int i2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1391199439, i2, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:340)");
            }
            ...
            Shape shape2 = shape;
            Modifier r1 = SelectableKt.m33588selectableO2vRcR0$default(SurfaceKt.m34133surface8ww4TTg(modifier, shape2, SurfaceKt.m34134surfaceColorAtElevationcq6XJ1M(this.$color, (ElevationOverlay) composer2.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 15) & 14), this.$border, this.$elevation), this.$selected, this.$interactionSource, RippleKt.m34235rememberRipple9IZ8Weo(false, 0.0f, 0, composer, 0, 7), this.$enabled, (Role) null, this.$onClick, 16, (Object) null);
