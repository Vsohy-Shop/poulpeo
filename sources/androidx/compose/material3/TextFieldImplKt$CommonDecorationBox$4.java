...
final class TextFieldImplKt$CommonDecorationBox$4 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    TextFieldImplKt$CommonDecorationBox$4(TextFieldType textFieldType, String str, C13088o<? super Composer, ? super Integer, C11921v> oVar, VisualTransformation visualTransformation, C13088o<? super Composer, ? super Integer, C11921v> oVar2, C13088o<? super Composer, ? super Integer, C11921v> oVar3, C13088o<? super Composer, ? super Integer, C11921v> oVar4, C13088o<? super Composer, ? super Integer, C11921v> oVar5, C13088o<? super Composer, ? super Integer, C11921v> oVar6, boolean z, boolean z2, boolean z3, InteractionSource interactionSource, PaddingValues paddingValues, TextFieldColors textFieldColors, C13088o<? super Composer, ? super Integer, C11921v> oVar7, int i, int i2, int i3) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ...
        TextFieldImplKt.CommonDecorationBox(textFieldType2, this.$value, this.$innerTextField, this.$visualTransformation, this.$label, this.$placeholder, this.$leadingIcon, this.$trailingIcon, this.$supportingText, this.$singleLine, this.$enabled, this.$isError, this.$interactionSource, this.$contentPadding, this.$colors, this.$container, composer2, this.$$changed | 1, this.$$changed1, this.$$default);
    }
}
