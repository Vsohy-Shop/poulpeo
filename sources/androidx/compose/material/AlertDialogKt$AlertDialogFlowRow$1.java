...
final class AlertDialogKt$AlertDialogFlowRow$1 implements MeasurePolicy {
    ...
    public final MeasureResult m33869measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        int i;
        C12760f0 f0Var;
        ArrayList arrayList;
        C12760f0 f0Var2;
        ...
        long Constraints$default = ConstraintsKt.Constraints$default(0, Constraints.m38412getMaxWidthimpl(j), 0, 0, 13, (Object) null);
        for (Measurable r1 : list) {
            Placeable r25 = r1.m37365measureBRTryo0(Constraints$default);
            long j2 = Constraints$default;
            C12760f0 f0Var7 = f0Var6;
            if (!measure_3p2s80s$canAddToCurrentSequence(arrayList5, f0Var5, measureScope, this.$mainAxisSpacing, j, r25)) {
                f0Var2 = f0Var5;
        ...
        if (Constraints.m38412getMaxWidthimpl(j) != Integer.MAX_VALUE) {
            ...
            i = Math.max(f0Var3.f20416b, Constraints.m38414getMinWidthimpl(j));
        }
        int i2 = i;
        return MeasureScope.layout$default(measureScope, i2, Math.max(f0Var9.f20416b, Constraints.m38413getMinHeightimpl(j)), (Map) null, new AlertDialogKt$AlertDialogFlowRow$1$measure$1(arrayList2, measureScope, this.$mainAxisSpacing, i2, arrayList4), 4, (Object) null);
    }
}
