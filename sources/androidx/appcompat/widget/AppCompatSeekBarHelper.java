...
class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0129R.styleable.AppCompatSeekBar;
        ...
        Drawable drawableIfKnown = obtainStyledAttributes.getDrawableIfKnown(C0129R.styleable.AppCompatSeekBar_android_thumb);
        if (drawableIfKnown != null) {
            this.mView.setThumb(drawableIfKnown);
        }
        setTickMark(obtainStyledAttributes.getDrawable(C0129R.styleable.AppCompatSeekBar_tickMark));
        int i2 = C0129R.styleable.AppCompatSeekBar_tickMarkTintMode;
        ...
        int i3 = C0129R.styleable.AppCompatSeekBar_tickMarkTint;
