...
public final class MaterialContainerTransform extends Transition {
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, mo636to = 1.0d) float f, @FloatRange(from = 0.0d, mo636to = 1.0d) float f2) {
            this.start = f;
            this.end = f2;
        }
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            float f9 = evaluate.currentStartWidth;
            rectF2.set(f7 - (f9 / 2.0f), f8, (f9 / 2.0f) + f7, evaluate.currentStartHeight + f8);
            ...
            rectF3.set(f7 - (f10 / 2.0f), f8, f7 + (f10 / 2.0f), fitModeResult2.currentEndHeight + f8);
            ...
            float f12 = (float) ((int) (calculateElevationDyMultiplier * f11));
            this.currentElevationDy = f12;
            this.shadowPaint.setShadowLayer(f11, (float) ((int) (calculateElevationDxMultiplier * f11)), f12, SHADOW_COLOR);
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (i != -1) {
            ...
            int i2 = C6372R.C6375id.mtrl_motion_snapshot_view;
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(new int[]{C6372R.attr.transitionShapeAppearance});
    ...
    private void maybeApplyThemeValues(Context context, boolean z) {
        int i;
        TransitionUtils.maybeApplyThemeInterpolator(this, context, C6372R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        if (z) {
            i = C6372R.attr.motionDurationLong2;
        } else {
            i = C6372R.attr.motionDurationMedium4;
        }
        TransitionUtils.maybeApplyThemeDuration(this, context, i);
        if (!this.pathMotionCustom) {
            TransitionUtils.maybeApplyThemePath(this, context, C6372R.attr.motionPath);
        }
    }
