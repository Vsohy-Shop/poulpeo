...
class FragmentStateManager {
    ...
    static /* synthetic */ class C22852 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentStateManager.C22852.<clinit>():void");
        }
    }
    ...
    public int computeExpectedState() {
        ...
        int i2 = C22852.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment.mMaxState.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                i = Math.min(i, 5);
            } else if (i2 == 3) {
    ...
    public void createView() {
        ...
        L_0x00c0:
            ...
            int r6 = androidx.fragment.C1989R.C1990id.fragment_container_view_tag
            r5.setTag(r6, r0)
    ...
    public void ensureInflatedView() {
        ...
        if (fragment.mFromLayout && fragment.mInLayout && !fragment.mPerformedCreateView) {
            ...
            if (view != null) {
                ...
                Fragment fragment3 = this.mFragment;
                fragment3.mView.setTag(C1989R.C1990id.fragment_container_view_tag, fragment3);
                Fragment fragment4 = this.mFragment;
