...
public class DiffUtil {
    private static final Comparator<Diagonal> DIAGONAL_COMPARATOR = new Comparator<Diagonal>() {
        public int compare(Diagonal diagonal, Diagonal diagonal2) {
            return diagonal.f1084x - diagonal2.f1084x;
        }
    };
    ...
    static class Diagonal {
        ...
        /* access modifiers changed from: package-private */
        public int endX() {
            return this.f1084x + this.size;
        }

        /* access modifiers changed from: package-private */
        public int endY() {
            return this.f1085y + this.size;
        }
    }
    ...
    public static class DiffResult {
        ...
        private void addEdgeDiagonals() {
            ...
            if (!(diagonal != null && diagonal.f1084x == 0 && diagonal.f1085y == 0)) {
        ...
        private void findMatchingItems() {
            ...
            for (Diagonal next : this.mDiagonals) {
                for (int i2 = 0; i2 < next.size; i2++) {
                    int i3 = next.f1084x + i2;
                    int i4 = next.f1085y + i2;
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mDiagonals.size() - 1; size >= 0; size--) {
                ...
                int i10 = diagonal.f1084x;
                int i11 = diagonal.f1085y;
