...
public final class C5432l9 implements C5491p5 {

    /* renamed from: a */
    private final Context f6105a;

    public C5432l9(Context context) {
        this.f6105a = (Context) C9713p.m20275j(context);
    }
    ...
    public final C5528rc<?> mo33133a(C5276b4 b4Var, C5528rc<?>... rcVarArr) {
        ...
        C9713p.m20266a(z2);
        try {
            return new C5315dd(this.f6105a.getPackageManager().getPackageInfo(this.f6105a.getPackageName(), 0).versionName);
        } catch (PackageManager.NameNotFoundException e) {
            String packageName = this.f6105a.getPackageName();
