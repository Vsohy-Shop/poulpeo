...
final class TextFieldImplKt$CommonDecorationBox$3$containerWithId$1 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    final /* synthetic */ int $$dirty1;
    final /* synthetic */ C13088o<Composer, Integer, C11921v> $container;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextFieldImplKt$CommonDecorationBox$3$containerWithId$1(C13088o<? super Composer, ? super Integer, C11921v> oVar, int i) {
        super(2);
        this.$container = oVar;
        this.$$dirty1 = i;
    }
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            C13089p<SkippableUpdater<ComposeUiNode>, Composer, Integer, C11921v> materializerOf = LayoutKt.materializerOf(layoutId);
