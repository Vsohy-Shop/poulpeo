...
public final class LazyStaggeredGridDslKt$itemsIndexed$5 extends C12777p implements C13090q<LazyStaggeredGridItemScope, Integer, Composer, Integer, C11921v> {
    final /* synthetic */ C13091r<LazyStaggeredGridItemScope, Integer, T, Composer, Integer, C11921v> $itemContent;
    final /* synthetic */ List<T> $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyStaggeredGridDslKt$itemsIndexed$5(C13091r<? super LazyStaggeredGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, C11921v> rVar, List<? extends T> list) {
        super(4);
