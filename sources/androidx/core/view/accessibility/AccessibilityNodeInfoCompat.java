...
public class AccessibilityNodeInfoCompat {
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        view.setTag(C1318R.C1321id.tag_accessibility_clickable_spans, sparseArray);
        return sparseArray;
    }

    private SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(C1318R.C1321id.tag_accessibility_clickable_spans);
    }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            if (clickableSpans != null && clickableSpans.length > 0) {
                getExtras().putInt(SPANS_ACTION_ID_KEY, C1318R.C1321id.accessibility_action_clickable_span);
    ...
    public TouchDelegateInfoCompat getTouchDelegateInfo() {
        ...
        if (Build.VERSION.SDK_INT < 29 || (a = this.mInfo.getTouchDelegateInfo()) == null) {
            return null;
        }
        return new TouchDelegateInfoCompat(a);
    }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public AccessibilityNodeInfoCompat getTargetForRegion(@NonNull Region region) {
            ...
            if (Build.VERSION.SDK_INT < 29 || (a = this.mInfo.getTargetForRegion(region)) == null) {
                return null;
            }
            return AccessibilityNodeInfoCompat.wrap(a);
        }
