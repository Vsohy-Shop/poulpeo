...
final class IconButtonKt$OutlinedIconToggleButton$3 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ C13088o<Composer, Integer, C11921v> $content;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    IconButtonKt$OutlinedIconToggleButton$3(C13088o<? super Composer, ? super Integer, C11921v> oVar, int i) {
        super(2);
        this.$content = oVar;
        this.$$dirty = i;
    }
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            oVar.invoke(composer, Integer.valueOf((i2 >> 24) & 14));
