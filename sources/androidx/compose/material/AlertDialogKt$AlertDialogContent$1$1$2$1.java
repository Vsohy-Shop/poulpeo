...
final class AlertDialogKt$AlertDialogContent$1$1$2$1 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    AlertDialogKt$AlertDialogContent$1$1$2$1(C13088o<? super Composer, ? super Integer, C11921v> oVar, int i) {
        super(2);
        this.$text = oVar;
        this.$$dirty = i;
    }
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, (C13088o<? super Composer, ? super Integer, C11921v>) ComposableLambdaKt.composableLambda(composer, 2115920639, true, new C13088o<Composer, Integer, C11921v>() {
                public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
                    invoke((Composer) obj, ((Number) obj2).intValue());
                    return C11921v.f18618a;
                }
                ...
                public final void invoke(Composer composer, int i) {
                    if ((i & 11) != 2 || !composer.getSkipping()) {
                        ...
                        TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer, 6).getBody2(), oVar, composer, (i2 >> 6) & 112);
                        if (ComposerKt.isTraceInProgress()) {
