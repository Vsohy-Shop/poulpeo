...
abstract class AbsActionBarView extends ViewGroup {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes((AttributeSet) null, C0129R.styleable.ActionBar, C0129R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0129R.styleable.ActionBar_height, 0));
    ...
    AbsActionBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0129R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
