...
final class BasicTextFieldKt$BasicTextField$12 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    BasicTextFieldKt$BasicTextField$12(String str, Function1<? super String, C11921v> function1, Modifier modifier, boolean z, boolean z2, TextStyle textStyle, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z3, int i, VisualTransformation visualTransformation, Function1<? super TextLayoutResult, C11921v> function12, MutableInteractionSource mutableInteractionSource, Brush brush, C13089p<? super C13088o<? super Composer, ? super Integer, C11921v>, ? super Composer, ? super Integer, C11921v> pVar, int i2, int i3, int i4) {
        super(2);
        this.$value = str;
