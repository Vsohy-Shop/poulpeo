...
final class OneDimensionalFocusSearchKt$generateAndSearchChildren$1 extends C12777p implements Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean> {
    ...
    public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
        ...
        Boolean valueOf = Boolean.valueOf(OneDimensionalFocusSearchKt.m35379searchChildren4C6V_qg(this.$this_generateAndSearchChildren, this.$focusedItem, this.$direction, this.$onFound));
