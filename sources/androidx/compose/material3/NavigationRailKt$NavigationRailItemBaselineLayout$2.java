...
final class NavigationRailKt$NavigationRailItemBaselineLayout$2 implements MeasurePolicy {
    ...
    NavigationRailKt$NavigationRailItemBaselineLayout$2(float f, C13088o<? super Composer, ? super Integer, C11921v> oVar, boolean z) {
    ...
    public final MeasureResult m34532measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        float f;
        Object obj;
        Placeable placeable;
        ...
        for (Measurable measurable : iterable) {
            if (C12775o.m28634d(LayoutIdKt.getLayoutId(measurable), "icon")) {
                ...
                float f2 = (float) 2;
                int width = r3.getWidth() + measureScope2.m38443roundToPx0680j_4(C1232Dp.m38468constructorimpl(NavigationRailKt.IndicatorHorizontalPadding * f2));
                ...
                int height = r3.getHeight() + measureScope2.m38443roundToPx0680j_4(C1232Dp.m38468constructorimpl(f * f2));
                for (Measurable measurable2 : iterable) {
                    if (C12775o.m28634d(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                        ...
                        placeable2 = null;
                        if (this.$label == null) {
                            return NavigationRailKt.m34528placeIconX9ElhV4(measureScope, r3, r4, placeable, j);
                        }
                        C12775o.m28636f(placeable2);
                        return NavigationRailKt.m34529placeLabelAndIconzUg2_y0(measureScope, placeable2, r3, r4, placeable, j, this.$alwaysShowLabel, this.$animationProgress);
                    }
                    long j3 = j;
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
