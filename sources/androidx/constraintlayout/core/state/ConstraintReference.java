...
public class ConstraintReference implements Reference {
    ...
    static /* synthetic */ class C12581 {
        ...
        static {
            ...
            L_0x00d8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.ConstraintReference.C12581.<clinit>():void");
        }
    }
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        if (target != null) {
            int[] iArr = C12581.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint;
    ...
    public ConstraintReference bias(float f) {
        ...
        int i = C12581.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()];
        if (i != 17) {
            if (i != 18) {
                switch (i) {
                    case 1:
    ...
    public ConstraintReference clear() {
        State.Constraint constraint = this.mLast;
        if (constraint != null) {
            switch (C12581.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
                case 1:
                case 2:
