...
final class ListItemKt$ListItem$4 extends C12777p implements C13089p<RowScope, Composer, Integer, C11921v> {
    ...
    ListItemKt$ListItem$4(C13088o<? super Composer, ? super Integer, C11921v> oVar, ListItemColors listItemColors, int i, C13088o<? super Composer, ? super Integer, C11921v> oVar2, C13088o<? super Composer, ? super Integer, C11921v> oVar3, C13088o<? super Composer, ? super Integer, C11921v> oVar4, C13088o<? super Composer, ? super Integer, C11921v> oVar5) {
        super(3);
    ...
    public final void invoke(RowScope rowScope, Composer composer, int i) {
        ...
        if ((i2 & 91) != 18 || !composer.getSkipping()) {
            ...
            if (oVar != null) {
                ListItemKt.m34483leadingContentiJQMabo(oVar, this.$colors.leadingIconColor$material3_release(true, composer2, ((this.$$dirty >> 15) & 112) | 6).getValue().m35681unboximpl(), true, composer, ((this.$$dirty >> 12) & 14) | 384).invoke(rowScope2, composer2, Integer.valueOf(i2 & 14));
            }
            composer.endReplaceableGroup();
            Modifier.Companion companion = Modifier.Companion;
            Modifier r1 = PaddingKt.m33272paddingqDBjuR0$default(RowScope.weight$default(rowScope, companion, 1.0f, false, 2, (Object) null), 0.0f, 0.0f, ListItemKt.ContentEndPadding, 0.0f, 11, (Object) null);
            ...
            C13088o<Composer, Integer, C11921v> oVar4 = this.$supportingText;
            ...
            Updater.m35299setimpl(r7, rememberBoxMeasurePolicy, companion3.getSetMeasurePolicy());
            Updater.m35299setimpl(r7, density, companion3.getSetDensity());
            Updater.m35299setimpl(r7, layoutDirection, companion3.getSetLayoutDirection());
            Updater.m35299setimpl(r7, viewConfiguration, companion3.getSetViewConfiguration());
            ...
            composer.disableReusing();
            Composer r72 = Updater.m35292constructorimpl(composer);
            Updater.m35299setimpl(r72, columnMeasurePolicy, companion3.getSetMeasurePolicy());
            ...
            int i5 = (i3 >> 18) & 14;
            long r12 = listItemColors.overlineColor$material3_release(composer2, i5).getValue().m35681unboximpl();
            ListTokens listTokens = ListTokens.INSTANCE;
            Composer composer3 = composer;
            ListItemKt.m34478ProvideTextStyleFromToken3JVO9M(r12, listTokens.getListItemOverlineFont(), oVar2, composer3, (i3 & MediaRouterJellybean.DEVICE_OUT_BLUETOOTH) | 48);
            ...
            ListItemKt.m34478ProvideTextStyleFromToken3JVO9M(listItemColors.supportingColor$material3_release(composer2, i5).getValue().m35681unboximpl(), listTokens.getListItemSupportingTextFont(), oVar4, composer3, ((i3 >> 3) & MediaRouterJellybean.DEVICE_OUT_BLUETOOTH) | 48);
            composer.endReplaceableGroup();
            composer.endReplaceableGroup();
            composer.endReplaceableGroup();
            composer.endNode();
            ...
            composer.endReplaceableGroup();
            composer.endReplaceableGroup();
            C13088o<Composer, Integer, C11921v> oVar5 = this.$trailingContent;
            if (oVar5 != null) {
                ListItemKt.m34484trailingContentiJQMabo(oVar5, this.$colors.trailingIconColor$material3_release(true, composer2, ((this.$$dirty >> 15) & 112) | 6).getValue().m35681unboximpl(), true, composer, ((this.$$dirty >> 15) & 14) | 384).invoke(rowScope, composer2, Integer.valueOf(i4 & 14));
            }
            if (ComposerKt.isTraceInProgress()) {
