...
final class CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$1 extends C12777p implements C13089p<Transition.Segment<ToggleableState>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    public final FiniteAnimationSpec<Float> invoke(Transition.Segment<ToggleableState> segment, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1324481169, i, -1, "androidx.compose.material3.CheckboxImpl.<anonymous> (Checkbox.kt:251)");
        }
