...
final class TabRowDefaults$Indicator$1 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    public final void invoke(Composer composer, int i) {
        this.$tmp0_rcvr.m34165Indicator9IZ8Weo(this.$modifier, this.$height, this.$color, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
