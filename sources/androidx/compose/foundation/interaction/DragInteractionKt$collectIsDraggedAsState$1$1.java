...
@C12739f(mo50609c = "androidx.compose.foundation.interaction.DragInteractionKt$collectIsDraggedAsState$1$1", mo50610f = "DragInteraction.kt", mo50611l = {84}, mo50612m = "invokeSuspend")
/* compiled from: DragInteraction.kt */
final class DragInteractionKt$collectIsDraggedAsState$1$1 extends C12746l implements C13088o<C13995l0, C12074d<? super C11921v>, Object> {
    ...
    DragInteractionKt$collectIsDraggedAsState$1$1(InteractionSource interactionSource, MutableState<Boolean> mutableState, C12074d<? super DragInteractionKt$collectIsDraggedAsState$1$1> dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C10962f<Interaction> interactions = this.$this_collectIsDraggedAsState.getInteractions();
            final MutableState<Boolean> mutableState = this.$isDragged;
            C04431 r3 = new C10967g<Interaction>() {
    ...
    public final Object invoke(C13995l0 l0Var, C12074d<? super C11921v> dVar) {
        return ((DragInteractionKt$collectIsDraggedAsState$1$1) create(l0Var, dVar)).invokeSuspend(C11921v.f18618a);
    }
}
