...
public class CustomSupport {
    ...
    static /* synthetic */ class C12801 {
        ...
        static final /* synthetic */ int[] f429x66adad53;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f429x66adad53     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f429x66adad53     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f429x66adad53     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f429x66adad53     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f429x66adad53     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f429x66adad53     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.motion.utils.CustomSupport.C12801.<clinit>():void");
        }
    }
    ...
    public static void setInterpolatedValue(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        try {
            boolean z = true;
            switch (C12801.f429x66adad53[constraintAttribute.getType().ordinal()]) {
                case 1:
            ...
            Log.e(TAG, "no method " + str + " on View \"" + Debug.getName(view) + AbstractDebugRequestMapper.QUOTE);
            e.printStackTrace();
        } catch (IllegalAccessException e2) {
            Log.e(TAG, "cannot access method " + str + " on View \"" + Debug.getName(view) + AbstractDebugRequestMapper.QUOTE);
            e2.printStackTrace();
