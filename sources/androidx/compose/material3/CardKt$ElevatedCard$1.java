...
final class CardKt$ElevatedCard$1 extends C12777p implements C13088o<Composer, Integer, C11921v> {
    ...
    CardKt$ElevatedCard$1(Modifier modifier, Shape shape, CardColors cardColors, CardElevation cardElevation, C13089p<? super ColumnScope, ? super Composer, ? super Integer, C11921v> pVar, int i, int i2) {
        super(2);
