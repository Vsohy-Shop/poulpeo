...
public class ShortcutInfoCompat {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull ShortcutInfo shortcutInfo) {
            ...
            shortcutInfoCompat.mIntents = (Intent[]) Arrays.copyOf(a, a.length);
    ...
    public ShortcutInfo toShortcutInfo() {
        ShortcutInfo.Builder a = new ShortcutInfo.Builder(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
        IconCompat iconCompat = this.mIcon;
        if (iconCompat != null) {
            ShortcutInfo.Builder unused = a.setIcon(iconCompat.toIcon(this.mContext));
        }
        if (!TextUtils.isEmpty(this.mLongLabel)) {
            ShortcutInfo.Builder unused2 = a.setLongLabel(this.mLongLabel);
        }
        if (!TextUtils.isEmpty(this.mDisabledMessage)) {
            ShortcutInfo.Builder unused3 = a.setDisabledMessage(this.mDisabledMessage);
        }
        ComponentName componentName = this.mActivity;
        if (componentName != null) {
        ...
        ShortcutInfo.Builder unused6 = a.setRank(this.mRank);
        PersistableBundle persistableBundle = this.mExtras;
        if (persistableBundle != null) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (personArr != null && personArr.length > 0) {
                ...
                ShortcutInfo.Builder unused8 = a.setPersons(personArr2);
            }
            LocusIdCompat locusIdCompat = this.mLocusId;
            if (locusIdCompat != null) {
                ShortcutInfo.Builder unused9 = a.setLocusId(locusIdCompat.toLocusId());
            }
            ShortcutInfo.Builder unused10 = a.setLongLived(this.mIsLongLived);
        } else {
            ShortcutInfo.Builder unused11 = a.setExtras(buildLegacyExtrasBundle());
        }
        return a.build();
    }
