...
final class ProgressIndicatorKt$CircularProgressIndicator$endAngle$1 extends C12777p implements Function1<KeyframesSpec.KeyframesSpecConfig<Float>, C11921v> {
    ...
    public final void invoke(KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
        ...
        keyframesSpecConfig.with(keyframesSpecConfig.mo4121at(Float.valueOf(0.0f), 0), ProgressIndicatorKt.CircularEasing);
        keyframesSpecConfig.mo4121at(Float.valueOf(290.0f), 666);
    }
}
