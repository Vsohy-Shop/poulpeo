...
final class NavigationRailKt$NavigationRailItemBaselineLayout$2 implements MeasurePolicy {
    ...
    NavigationRailKt$NavigationRailItemBaselineLayout$2(C13088o<? super Composer, ? super Integer, C11921v> oVar, float f) {
        this.$label = oVar;
        this.$iconPositionAnimationProgress = f;
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public final MeasureResult m34068measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        Placeable placeable;
        ...
        for (Measurable measurable : iterable) {
            if (C12775o.m28634d(LayoutIdKt.getLayoutId(measurable), "icon")) {
                ...
                placeable = null;
                if (this.$label == null) {
                    return NavigationRailKt.m34066placeIcon3p2s80s(measureScope, r12, j2);
                }
                C12775o.m28636f(placeable);
                return NavigationRailKt.m34067placeLabelAndIconDIyivk0(measureScope, placeable, r12, j, this.$iconPositionAnimationProgress);
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
